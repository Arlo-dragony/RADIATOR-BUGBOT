...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./XeonMedia/images (6).jpeg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./XeonMedia/images (6)/${BhosdikaXeon}.jpeg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./XeonMedia/d84afa49af5b88381b967cd55eee6e3d/${BhosdikaXeon}.mp4`)
...
if (typemenu === 'v1') {
      ...
      title: botname,
      body: ownername,
      thumbnailUrl: 'https://telegra.ph/file/cc872e19bc191d8fea29c.mp4',
      sourceUrl: ``,
      mediaType: 1,
      renderLargerThumbnail: true
      }
